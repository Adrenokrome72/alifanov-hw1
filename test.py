...
print(f"Студент {student_1.name} {student_1.surname} учится лучше чем студент {student_2.name} {student_2.surname}?\nРезультат:{student_1 < student_2}\n")


print("Сравнение лекторов:\n")
#Сравнение лекторов по средней оценке за лекции:

print(f"Лектор {lecturer_1.name} {lecturer_1.surname} нравится студентам больше чем лектор {lecturer_2.name} {lecturer_2.surname}?\nРезультат:{lecturer_1 < lecturer_2}\n")
